    ...
    const sampleApps = [
        {
            ...
            category: 'Browser',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=1200&h=800' }
            ],
            rating: 4.8,
            reviewsCount: 3420,
        ...
        },
        {
            ...
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&h=800' }
            ],
            rating: 4.9,
            reviewsCount: 4780,
        ...
        },
        {
            ...
            category: 'Productivity',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1517842645767-c639042777db?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&h=800' }
            ],
            rating: 4.7,
            reviewsCount: 4520,
        ...
        },
        {
            ...
            category: 'Productivity',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?w=1200&h=800' }
            ],
            rating: 4.8,
            reviewsCount: 3890,
        ...
        },
        {
            ...
            category: 'Design',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1572044162444-ad60f128bdea?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1609921141835-710b7fa6e438?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1626785774625-ddcddc3445e9?w=1200&h=800' }
            ],
            rating: 4.9,
            reviewsCount: 4920,
        ...
        },
        {
            ...
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1484417894907-623942c8ee29?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?w=1200&h=800' }
            ],
            rating: 4.8,
            reviewsCount: 4650,
        ...
        },
        {
            ...
            category: 'Media',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1536240478700-b869070f9279?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?w=1200&h=800' }
            ],
            rating: 4.7,
            reviewsCount: 2340,
        ...
        },
        {
            ...
            category: 'Utilities',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1527689368864-3a821dbccc34?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1200&h=800' },
        ...
        },
        {
            ...
            category: 'Productivity',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1200&h=800' }
            ],
            rating: 4.9,
            reviewsCount: 3120,
        ...
        },
        {
            ...
            category: 'Development',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1518432031352-d6fc5c10da5a?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1200&h=800' }
            ],
            rating: 4.7,
            reviewsCount: 2680,
        ...
        },
        {
            ...
            category: 'Productivity',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1455390582262-044cdead277a?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1471107340929-a87cd0f5b5f3?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1200&h=800' }
            ],
            rating: 4.8,
            reviewsCount: 3560,
        ...
        },
        {
            ...
            category: 'Productivity',
            screenshots: [
                { url: 'https://images.unsplash.com/photo-1540350394557-8d14678e7f91?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?w=1200&h=800' },
                { url: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=1200&h=800' }
            ],
